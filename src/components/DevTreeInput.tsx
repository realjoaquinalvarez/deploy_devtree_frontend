...
type DevTreeInputProps = {
    ...
    switchEnabled: (socialNetwork: string) => void
}

export default function DevTreeInput({ item, handleUrlInput, switchEnabled }: DevTreeInputProps) {
    return (
        <div className="bg-white shadow-sm p-5 flex items-center gap-3 rounded-lg">
            ...
            <Switch
                ...
                onChange={() => switchEnabled(item.name)}
